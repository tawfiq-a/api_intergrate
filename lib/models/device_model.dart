...
List<DeviceDetails> deviceDetailsFromJson(String str) => List<DeviceDetails>.from(json.decode(str).map((x) => DeviceDetails.fromJson(x)));

String deviceDetailsToJson(List<DeviceDetails> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
